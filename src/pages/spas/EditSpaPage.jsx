...
// BASE_URL removed - using spaService instead
  ...
  useEffect(() => {
    const fetchSpaData = async () => {
      ...
      try {
        ...
        // Fetch spa by ID using spaService
        const foundSpa = await spaService.getSpaById(effectiveSpaId);
...
const validateFile = (file) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Send data to the API using spaService
      await spaService.updateSpa(effectiveSpaId, formDataObj);
      ...
      const errorMessage = err.response?.data?.message || 
                          ...
                          err.message || 
                          'Failed to update spa. Please try again.';
