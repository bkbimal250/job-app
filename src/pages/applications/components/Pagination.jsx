    ...
    <div className="bg-white rounded-xl shadow-md border border-gray-200 p-5 mt-6">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-sm text-gray-700 bg-gray-50 px-4 py-2 rounded-lg">
          {totalItems > 0 ? (
            <>
              ...
              <span className="font-bold text-gray-900">{totalItems}</span> applications
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="text-sm font-semibold text-gray-700 bg-indigo-50 px-4 py-2.5 rounded-xl border border-indigo-200">
